...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/guilhem/.local/share/qutebrowser/userscripts/*')
...
c.colors.statusbar.insert.bg = '#62a87c'
c.colors.statusbar.insert.fg = '#000000'

c.colors.tabs.bar.bg = '#1a1a20'
c.colors.tabs.even.bg = '#1a1a20'
c.colors.tabs.odd.bg = '#1b1b21'
c.colors.tabs.selected.even.bg = '#62a87c'
c.colors.tabs.selected.odd.bg = '#62a87c'
