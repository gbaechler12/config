...
_G.packer_plugins = {
  LuaSnip = {
    ...
    loaded = true,
    path = "/home/guilhem/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  vimtex = {
    loaded = true,
    path = "/home/guilhem/.local/share/nvim/site/pack/packer/start/vimtex",
